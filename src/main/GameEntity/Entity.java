...
public abstract class Entity {
	public enum ENTITY_TYPE {
		CANNON, ALIEN, LASERBOLT
	}

	// TODO: The add, remove observer methods and the notify method are still
	// missing here for our observer pattern

	/*
	 * This is our abstract parent class for our Game Entities like Canon and Alien.
	 * It can be compared to the parent class Car form Bumpers.
	 */
	 ...
	 */
	// TODO: This drive method has to be updated for key presses (e.g. as long as I
	// press the arrow-right key the cannon moves right till the border is reached).
